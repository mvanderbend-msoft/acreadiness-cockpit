...
4. **Hand off to the `ai-readiness-reporter` custom agent** to interpret the JSON and produce `reports/index.html`. The agent:
   ...
   - Breaks down all 9 pillars across **Repo Health** (8) and **AI Setup** (1) with *what it measures*, *why it matters for AI*, and *a specific recommendation*.
   ...
   - Embeds the raw AgentRC JSON for re-use.
