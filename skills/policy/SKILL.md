---
name: policy
description: "Help the user pick, write, or apply an AgentRC policy. Policies customise readiness scoring — disable irrelevant checks, override impact/level, set pass-rate thresholds, or chain org baselines with team overrides. Use when the user asks about strict mode, AI-only scoring, custom weights, CI gating, or wants org-wide standardisation."
